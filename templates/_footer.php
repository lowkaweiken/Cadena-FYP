...
<script type="text/javascript" src="js/abi/AutoSupplyChainAbi.js"></script>
...
{
    ?>
    <script type="text/javascript" src="js/app/admin_.js"></script>
    <?php
}
elseif(isset($_SERVER['SCRIPT_NAME']) && strpos($_SERVER['SCRIPT_NAME'], "user.php") !== false)
{
    ?>
    <script type="text/javascript" src="js/app/user_.js"></script>
    <?php
}
?>

<script type="text/javascript" src="js/app/batch-details_.js"></script>
